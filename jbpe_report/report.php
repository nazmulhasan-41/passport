...
function form_list_print(brcode,frm_date,to_date){
	...
	var rurl='rpt_pe_List_report_fpdf.php/'+brcode+ '/' +frm_date+ '/' +to_date;
	//alert(rurl);
	window.open(rurl);		
}
...
<center>
  <table width="100%"  border="0" class="indexbox">
    ...
    <tr>
      <td width="100%" colspan="2" class="tbg" ><strong>DAILY PASSPORT ENDORSED REPORT</strong>
	  </td>
    </tr>
    <tr>
      <td colspan="2">
    ...
    <tr>
      <td colspan="2"><form action="" method="post" enctype="multipart/form-data" name="frmupload">
        <table width="100%" border="1" align="center" cellpadding="10"  cellspacing="2" bordercolor="#CCCCCC">
          <tr>
            <td colspan="5"><div align="center"><strong>DAILY ENDORSEMENT REPORT</strong></div>
			</td>
		</tr>
		<tr>
