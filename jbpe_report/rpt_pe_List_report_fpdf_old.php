...
{ 
	...
	$this->Cell(12,5,'TM For',1,0,'L');
	$this->Cell(20,5,'Endorse Date',1,0,'C');
	$this->Cell(19,5,'FC Amnt',1,0,'L');
	$this->Cell(18,5,'Amnt. BDT',1,0,'L');
...
while ($row_form=sqlsrv_fetch_array($result_form2)) {
		...
		$pdf->Cell(12,5,$tmFor,1,0,'L');	
		$pdf->Cell(20,5,$row_form['TM_DATE'],1,0,'C');
		$pdf->Cell(19,5,$row_form['SFC_BANK'],1,0,'R');	
		$pdf->Cell(18,5,$row_form['AMOUNT_IN_BDT'],1,0,'R');
		...
		$pdf->Cell(19,5,''.number_format($TotalFC,2),1,0,'R');
		$pdf->Cell(18,5,''.number_format($TotalBdt,4),1,0,'R');
