				  ...
				  -->
				    <td >
							<?PHP
							  ...
							  $tblcaption="Unverified Customer List";
							  $colHeader="Cust First Name,Cust Last Name,Birth Date,NID Number,Father Name,Mother Name,Acc Number,Acc Name,Routing Number,Mobile No,Bhata Type,Verify";
							  //,Edit,Authorize
							  ...
							  $sql="SELECT  [custFirstName]
										...
										WHERE [branchCode]=".$branchCode."AND
										[nEPSEnrollStatus] = 0 AND[requestSubmissionStatus]=1 AND [submissionStatus]='S'";
								
								
							   $dataviewclass->form_data_list($tblcaption,$colHeader,$sql,$editlink,$baseroot,$conn);
