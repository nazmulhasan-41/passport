...
<center>
  <table width="100%"  border="0" class="indexbox">
    ...
    <tr>
      <td width="100%" colspan="2" class="tbg" ><strong>SUCCESSFULLY ENROLLED REPORT</strong>
	  </td>
    </tr>
    <tr>
      <td colspan="2">
    ...
    <tr>
      <td colspan="2"><form action="" method="post" enctype="multipart/form-data" name="frmupload">
        <table width="100%" border="1" align="center" cellpadding="10"  cellspacing="2" bordercolor="#CCCCCC">
          <tr>
            <td colspan="5"><div align="center"><strong>SUCCESSFULLY ENROLLED CUSTOMER'S LIST</strong></div>
			</td>
		</tr>
		<tr>
            ...
            <td><!--input type="Submit" name="Submit" value="Show"/-->
              <input type="button" name="Submit2" value="Print" onclick="form_list_print(cmbthisbranchlist.value,txtfrm_date.value,txtto_date.value);" />
            </td>
          </tr>
