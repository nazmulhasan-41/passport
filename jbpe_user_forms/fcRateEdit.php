            ...
            <table width="100%"  cellspacing="0" cellpadding="0" class="msgbox">
                ...
                <td >
							<?PHP
							  ...
							  $tblcaption="Endrosed Failed List";
							  $Date = date("Y-m-d");	
							  
							  //FC Rate edit list ALL
							  /*
							  ...
							  $sql="SELECT convert(varchar, [Date], 23)
										  ...
										  ,[KWD]
										  ,[AED] 
										  ,[FC_RATE_ID],CREATED_BY
										  FROM [dbjbPassportEndorse].[dbo].[ExchangeRate]
										  WHERE [Date]='".$Date."' AND [SUBMISSION_STATUS] = 'R'";
															
							   $dataviewclass->edit_fc_error_rate($tblcaption,$colHeader,$sql,$editlink,$baseroot,$conn);
							   */
							   
							   
							   //FC Rate edit list ALL
							   $colHeader=" Date, US DOLLAR Rate, Edit";
							  //,Edit,Authorize
							  ...
							  $sql="SELECT convert(varchar, [Date], 23)
							   ...
							   $dataviewclass->edit_fc_error_rate_dollar($tblcaption,$colHeader,$sql,$editlink,$baseroot,$conn);
