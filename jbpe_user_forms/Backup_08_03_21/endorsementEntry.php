			...
			<td style="align:left;">
				<table id="tmForm">
					<tr>
						...
						<td>
								<input name="txt_passportnumber" type="text" id="txt_passportnumber"  value="<?PHP echo $passportNo;?>" size="20" autocomplete="off"  placeholder="Passport Number ?" maxlength="10"  required />
